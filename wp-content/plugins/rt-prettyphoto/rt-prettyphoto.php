...
function royal_prettyphoto_plugin_links($links, $file) {
	...
	if ($file == $base) {
		$links[] = '<a href="https://wordpress.org/plugins/rt-prettyphoto/installation/" target="_blank">' . __( 'Installation', 'rsb' ) . '</a>';
		$links[] = '<a href="https://www.royaltechbd.com/" target="_blank">' . __( 'Royal Technologies', 'rsb' ) . '</a>';
		$links[] = '<a href="https://www.shamokaldarpon.com/" target="_blank">' . __( 'Shamokal Darpon', 'rsb' ) . '</a>';
	}
	return $links;
}
