					...
					<div class="portfolio_content entry-content">
						<div class="entry">
							...
							<div class="portfolio_short_content">
                             <a class="lightbox portfolio_thumb" rel="portfolio_fancybox" href="<?php echo $image_large[0]; ?>" title="<?php echo $image_desc; ?>">
									<img class="alignright" src="<?php echo $image[0]; ?>" width="<?php echo $portfolio_options['prtfl_custom_size_px'][0][0]; ?>" height="<?php echo $portfolio_options['prtfl_custom_size_px'][0][1]; ?>" alt="<?php echo $image_alt; ?>" />
								</a>
							<!-- .portfolio_thumb -->
